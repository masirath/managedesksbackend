        ...
        if (selected_purchase_number) {
          ...
          for (value of details) {
            ...
            if (selected_product) {
              ...
              let purchase_unit_name = value?.unit_name ? value?.unit_name : "";
              ...
              let purchase_delivered = value?.delivered ? value?.delivered : 0;
                ...
                if (selected_product?._id == value?.unit) {
                  ...
                  if (unit_ids?.includes(value?.unit)) {
                    ...
                    if (
                      ...
                      purchase_conversion = parseFloat(purchase_conversion) - 1;
                    }
                  }
                }
              }
          ...
          if (details?.length === purchase_details?.length) {
            ...
            const purchase_order = new purchase_orders({
              ...
              date: date,
              due_date: due_date,
              subtotal: purchase_subtotal ? purchase_subtotal : 0,
              taxamount: purchase_taxamount ? purchase_taxamount : 0,
              discount: purchase_discount ? purchase_discount : 0,
              delivery: purchase_delivery ? purchase_delivery : 0,
              delivery_status: data_delivery_status ? data_delivery_status : 0,
              delivery_date: data_delivery_date,
              payment_status: data_payment_status ? data_payment_status : 0,
              ...
              if (selected_product) {
                ...
                if (selected_inventory_number) {
                  ...
                  const inventory = new inventories({
                    number: assigned_innevtory_number,
                    purchase: purchase_order_save?._id,
                    detail: purchase_order_detail_save?._id,
            ...
            failed_400(res, "Purchase order failed");
          }
        }
      }
    } else {
